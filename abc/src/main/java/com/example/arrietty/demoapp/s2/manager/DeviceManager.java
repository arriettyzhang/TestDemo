...
import com.example.arrietty.demoapp.s2.model.ReceiveBeanParent;
import com.example.arrietty.demoapp.s2.tcp.SocketReceiver;
...
public class DeviceManager implements SocketReceiver{
    ...
    public final List<ReceiveEventCallback> mReceiveEventCallback;
    public final List<TcpLinkCallback> mTcpLinkCallback;
    private TcpClient tcpClient;
    private DeviceManager(){
        mReceiveEventCallback = Collections.synchronizedList(new ArrayList<ReceiveEventCallback>());
     ...
     * @param listener
     */
    public void addReceiveEventCallbackListener(ReceiveEventCallback listener) {
        mReceiveEventCallback.add(listener);
    }
     ...
     * @param listener
     */
    public void removeReceiveEventCallbackListener(ReceiveEventCallback listener) {
        mReceiveEventCallback.remove(listener);
    }
    public void getDeviceInfoCallback(DeviceInfoBean infoBean, int cmdId) {
        for (ReceiveEventCallback mc : mReceiveEventCallback) {
